...
package com.chrisa.cron19.core.ui.widgets.charts
...
import kotlinx.android.synthetic.main.core_widget_bar_chart.view.chart
...
class BarChart(
    ...
    init {
        LayoutInflater.from(context).inflate(R.layout.core_widget_bar_chart, this, true)
        initChart()
        initXAxis()
        initYAxis()
    }
