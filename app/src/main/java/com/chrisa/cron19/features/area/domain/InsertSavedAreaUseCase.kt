...
import com.chrisa.cron19.features.area.domain.mappers.SavedAreaDtoMapper
import javax.inject.Inject

class InsertSavedAreaUseCase @Inject constructor(
    private val areaDataSource: AreaDataSource
) {
    fun execute(areaCode: String) {
        return areaDataSource.insertSavedArea(
