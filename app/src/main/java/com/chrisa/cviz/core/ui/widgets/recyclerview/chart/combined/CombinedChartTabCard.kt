...
@ModelView(defaultLayout = R.layout.core_widget_combined_chart_tab_card)
class CombinedChartTabCard(context: Context, attrs: AttributeSet) :
    MaterialCardView(context, attrs) {

    private val adapter = CombinedChartAdapter()
