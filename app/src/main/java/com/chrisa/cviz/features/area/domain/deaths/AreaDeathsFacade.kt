...
class AreaDeathsFacade @Inject constructor(
    ...
    fun publishedDeaths(
        ...
        publishedDeathsUseCase.deaths(areaCode, areaType, areaLookup)
    ...
    fun onsDeaths(
        ...
        onsDeathsUseCase.deaths(areaCode, areaType, areaLookup)
}
