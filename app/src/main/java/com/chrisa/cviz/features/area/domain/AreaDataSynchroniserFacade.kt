...
class AreaDataSynchroniserFacade @Inject constructor(
    private val areaLookupUseCase: AreaLookupUseCase,
    private val soaDataUseCase: SoaDataUseCase,
    private val areaDetailSynchroniser: AreaDetailSynchroniser
) {
    suspend fun performSync(
        ...
        areaDetailSynchroniser.performSync(areaCode, areaType)
    }
}
